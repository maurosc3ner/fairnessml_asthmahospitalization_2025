...
v1
bootstrapping for catboost LoS outcome
...
# data matrix
dtrain.rb=df2CatboostLos(data,'rb',F)
dvalid.rb=df2CatboostLos(data.splitted.los[[idx]]$data2.valid,'rb',F)
dtrain.rn=df2CatboostLos(data,'rn',F)
dvalid.rn=df2CatboostLos(data.splitted.los[[idx]]$data2.valid,'rn',F)
## Prepare dataset
...
# for(i in 1:3){
  ...
  # data matrix
  dtrain.rb=df2CatboostLos(data,'rb',onehot = F)
  dvalid.rb=df2CatboostLos(data.splitted.los[[idx]]$data2.valid,'rb',onehot = F)
  dtrain.rn=df2CatboostLos(data,'rn',onehot = F)
  dvalid.rn=df2CatboostLos(data.splitted.los[[idx]]$data2.valid,'rn',onehot = F)
  ...
  testDF.los.catb.bt<-rbind(testDF.los.catb.bt,
...
```{r}
save(testDF.los.catb.bt,file = "testDF.los.catb.bt.RData",compress = T)
```


```{r}
rbind(
confidence_interval(testDF.los.catb.bt %>% filter(groupoi=='White_EA' & algo=='rb.catb') %>% pull(sensitivity),0.95),
confidence_interval(testDF.los.catb.bt %>% filter(groupoi=='White_EA' & algo=='rn.catb') %>% pull(sensitivity),0.95))

rbind(
confidence_interval(testDF.los.catb.bt %>% filter(groupoi=='Black_AA' & algo=='rb.catb') %>% pull(sensitivity),0.95),
confidence_interval(testDF.los.catb.bt %>% filter(groupoi=='Black_AA' & algo=='rn.catb') %>% pull(sensitivity),0.95))

rbind(
confidence_interval(testDF.los.catb.bt %>% filter(groupoi=='Asian' & algo=='rb.catb') %>% pull(sensitivity),0.95),
confidence_interval(testDF.los.catb.bt %>% filter(groupoi=='Asian' & algo=='rn.catb') %>% pull(sensitivity),0.95))

rbind(
confidence_interval(testDF.los.catb.bt %>% filter(groupoi=='HL' & algo=='rb.catb') %>% pull(sensitivity),0.95),
confidence_interval(testDF.los.catb.bt %>% filter(groupoi=='HL' & algo=='rn.catb') %>% pull(sensitivity),0.95))

rbind(
confidence_interval(testDF.los.catb.bt %>% filter(groupoi=='MENA' & algo=='rb.catb') %>% pull(sensitivity),0.95),
confidence_interval(testDF.los.catb.bt %>% filter(groupoi=='MENA' & algo=='rn.catb') %>% pull(sensitivity),0.95))
```

```{r}
rbind(
confidence_interval(testDF.los.catb.bt %>% filter(groupoi=='White_EA' & algo=='rb.catb.up') %>% pull(sensitivity),0.95),
confidence_interval(testDF.los.catb.bt %>% filter(groupoi=='White_EA' & algo=='rn.catb.up') %>% pull(sensitivity),0.95))

rbind(
confidence_interval(testDF.los.catb.bt %>% filter(groupoi=='Black_AA' & algo=='rb.catb.up') %>% pull(sensitivity),0.95),
confidence_interval(testDF.los.catb.bt %>% filter(groupoi=='Black_AA' & algo=='rn.catb.up') %>% pull(sensitivity),0.95))

rbind(
confidence_interval(testDF.los.catb.bt %>% filter(groupoi=='Asian' & algo=='rb.catb.up') %>% pull(sensitivity),0.95),
confidence_interval(testDF.los.catb.bt %>% filter(groupoi=='Asian' & algo=='rn.catb.up') %>% pull(sensitivity),0.95))

rbind(
confidence_interval(testDF.los.catb.bt %>% filter(groupoi=='HL' & algo=='rb.catb.up') %>% pull(sensitivity),0.95),
confidence_interval(testDF.los.catb.bt %>% filter(groupoi=='HL' & algo=='rn.catb.up') %>% pull(sensitivity),0.95))

rbind(
confidence_interval(testDF.los.catb.bt %>% filter(groupoi=='MENA' & algo=='rb.catb.up') %>% pull(sensitivity),0.95),
confidence_interval(testDF.los.catb.bt %>% filter(groupoi=='MENA' & algo=='rn.catb.up') %>% pull(sensitivity),0.95))
```
